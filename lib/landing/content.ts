...
export const CLOSING_CTA_COPY = {
  title: "Sözlerim artık sizinle kalsın.",
  text:
    "Bu kitabı yıllarca taşıdım; şimdi size bırakıyorum. Satın aldığınız anda tam metin dijital okuyucuda açılır — sayfa sayfa, acele etmeden. Kararsızsanız önce bir şiir ya da deneme okuyun. Gelirin tamamını TEMA ve Darüşşafaka'ya bağışlıyorum; uzun zamandır her iki vakfın bağışçısıyım, okurken payı onlarla da paylaşırsınız.",
  ctaBuy: "Satın al",
